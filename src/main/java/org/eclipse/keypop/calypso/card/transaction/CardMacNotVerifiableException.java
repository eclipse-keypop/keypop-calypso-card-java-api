 ...
 * @since 2.0.0
 */
public final class CardMacNotVerifiableException extends RuntimeException {

  /**
   * @param message The message to identify the exception context.
   * @since 1.2.0
   */
  public CardMacNotVerifiableException(String message) {
    super(message);
  }
   ...
   * @since 1.2.0
   */
  public CardMacNotVerifiableException(String message, Throwable cause) {
    super(message, cause);
  }
}
